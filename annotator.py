...
def gradio_interface(json_file_path):
    ...
    def get_current_item(index):
        ...
        return image, level_1_options, level_2_options, level_3_options

    # 初始化数据
    image_path, level_1_options, level_2_options, level_3_options = get_current_item(current_index)
    ...
    def handle_save(selected_level_1, selected_level_2, selected_level_3, coordinates=None):
        ...
        return f"Saved options: Level 1 - {selected_level_1}, Level 2 - {selected_level_2}, Level 3 - {selected_level_3}"
